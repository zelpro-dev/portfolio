...
export default function Component() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Dashboard interactivo del clima con visualizaciones avanzadas",
    ...
    },
    {
      ...
      description: "Sitio web portfolio responsive con animaciones fluidas",
      image: "/placeholder.svg?height=200&width=300",
  ...
  return (
    ...
    >
      ...
      <section className="min-h-screen flex items-center justify-center">
        <div className="text-center space-y-8 px-6">
          ...
          >
            <Badge
              variant="outline"
              className="rounded-full px-6 py-3 bg-transparent border-neutral-600 text-neutral-300 hover:border-blue-400 hover:text-blue-400 transition-all duration-200"
            >
            ...
            <Badge
              variant="outline"
              className="rounded-full px-6 py-3 bg-transparent border-neutral-600 text-neutral-300 hover:border-purple-400 hover:text-purple-400 transition-all duration-200"
            >
            ...
            <Badge
              variant="outline"
              className="rounded-full px-6 py-3 bg-transparent border-neutral-600 text-neutral-300 hover:border-green-400 hover:text-green-400 transition-all duration-200"
            >
          ...
          >
            <Button
              className="bg-white text-black hover:bg-neutral-200 hover:scale-105 transition-all duration-200 rounded-full px-8 py-3 font-medium"
              onClick={() => scrollToSection("projects")}
            >
              Ver Proyectos
        ...
        <section id="about" className="space-y-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {skills.map((skill, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="text-center space-y-4 p-6 rounded-2xl bg-neutral-900/30 hover:bg-neutral-900/50 hover:scale-105 transition-all duration-300 group"
                  >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
            {[
              ...
              <div
                key={index}
                className="text-center space-y-2 p-4 rounded-2xl bg-neutral-900/20 hover:bg-neutral-900/40 transition-all duration-200"
              >
        ...
        <section id="projects" className="space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {projects.map((project, index) => (
              <Card
                key={index}
                className="rounded-2xl border border-neutral-800 bg-neutral-900/30 hover:bg-neutral-900/50 transition-all duration-300 hover:-translate-y-2 group"
              >
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <Link href={project.link} target="_blank">
                    <Button className="w-full rounded-full bg-white text-black hover:bg-neutral-200 hover:scale-105 transition-all duration-200 mt-6">
                      Ver Proyecto
                      <ExternalLink className="w-4 h-4 ml-2" />
                    </Button>
                  </Link>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {experience.map((exp, index) => (
                  <Card
                    key={index}
                    className="rounded-2xl border border-neutral-800 bg-neutral-900/30 hover:bg-neutral-900/50 transition-all duration-200"
                  >
        ...
        <section id="contact" className="space-y-16">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              {/* Contact Form */}
              <Card className="rounded-2xl border border-neutral-800 bg-neutral-900/30 hover:bg-neutral-900/50 transition-all duration-300">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className="bg-neutral-800/50 border-neutral-700 text-white placeholder-neutral-400 rounded-xl focus:border-blue-400 transition-colors duration-200"
                          required
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className="bg-neutral-800/50 border-neutral-700 text-white placeholder-neutral-400 rounded-xl focus:border-purple-400 transition-colors duration-200"
                          required
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          rows={5}
                          className="bg-neutral-800/50 border-neutral-700 text-white placeholder-neutral-400 rounded-xl focus:border-green-400 transition-colors duration-200 resize-none"
                          required
                        />
                      </div>
                      ...
                      <Button
                        type="submit"
                        className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-medium py-3 rounded-xl hover:scale-105 transition-all duration-200"
                      >
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        <Button
                          key={index}
                          variant="outline"
                          className="w-full rounded-xl border-neutral-700 bg-transparent text-white hover:bg-neutral-800 hover:scale-105 justify-start h-16 transition-all duration-200"
                        >
      ...
      {/* Footer */}
      <footer className="border-t border-neutral-800 bg-neutral-900/20 py-16">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center space-y-6 mb-12">
              ...
              <div>
                ...
                <p className="text-neutral-400">Full Stack Web Developer</p>
              </div>
            </div>
                ...
                <div className="flex justify-center md:justify-end space-x-4">
                  {[Github, Linkedin, Instagram].map((Icon, index) => (
                    <a
                      key={index}
                      href="#"
                      className="w-10 h-10 bg-neutral-800 rounded-full flex items-center justify-center text-neutral-400 hover:text-white hover:scale-110 transition-all duration-200"
                    >
